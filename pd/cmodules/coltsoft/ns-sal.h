...
/* Copyright (C) 2016-2022 Stuart Swales */
...
#else /* SAL1.1 or none */
#define _In_reads_c_(size)                              _In_count_c_(size)
#define _In_reads_x_(size)                              _In_count_x_(size)
#define _In_reads_opt_c_(size)                          _In_opt_count_c_(size)
#define _In_reads_bytes_c_(size)                        _In_bytecount_c_(size)
#define _In_reads_bytes_x_(size)                        _In_bytecount_x_(size)
#endif
...
#else /* SAL1.1 or none */
#define _Out_writes_c_(size)                            _Out_cap_c_(size)
#define _Out_writes_bytes_c_(size)                      _Out_bytecap_c_(size)
#endif
...
#else /* SAL1.1 or none */
#define _Inout_updates_x_(size)                         _Inout_count_x_(size)
#define _Inout_updates_bytes_x_(size)                   _Inout_bytecount_x_(size)
#endif
